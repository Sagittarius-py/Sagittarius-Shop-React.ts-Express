...
const ShoppingCart = () => {
    ...
    return (
        ...
        <div className="z-40 flex items-center justify-center  right-4 ">
            ...
            <div className={`px-4 fixed flex flex-col items-center bottom-0 right-0 z-40 h-screen bg-zinc-950 ${cartOpened ? "w-96" :" w-0 px-0 "} duration-200 shadow-xl shadow-orange-500/30 pt-20`}>
