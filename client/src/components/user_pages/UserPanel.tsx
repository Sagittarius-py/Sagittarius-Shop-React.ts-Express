...
const UserPanel = () => {
    ...
    return(
        ...
        <div className="z-40 flex items-center justify-center  right-4 ">
            ...
            <div className={`fixed bottom-0  right-0 z-40 h-screen bg-zinc-950 pt-16 ${profileOpened ? "mr-0" :" -mr-96"} w-96 p-4 duration-700 shadow-xl shadow-orange-500/30 ease-in-out`}>
              {!cookies.userId ? 
              <>
              <Login />
              <Register />
